#################################################################################
#
# Created by Genus(TM) Synthesis Solution 20.11-s111_1 on Thu Dec 01 23:55:21 UTC 2022
#
#################################################################################
...
create_constraint_mode -name CM_riscv_pipe_slow \
    -sdc_files { outputs_Dec01-23:19:04/RISC_V_pipeline_opt.CM_riscv_pipe_slow.sdc }
create_constraint_mode -name CM_riscv_pipe_fast \
    -sdc_files { outputs_Dec01-23:19:04/RISC_V_pipeline_opt.CM_riscv_pipe_fast.sdc }
