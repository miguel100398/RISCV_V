...
# Generated on: Fri Dec 02 00:01:02 UTC 2022 (Fri Dec 02 00:01:02 UTC 2022)
...
set_log_file logs_Dec01-23:19:04/intermediate2final.lec.log -replace

usage -auto -elapse

set_verification_information RISC_V_pipeline_intermediatev_RISC_V_pipeline_optv_db

read_implementation_information fv/RISC_V_pipeline -golden RISC_V_pipeline_intermediatev -revised RISC_V_pipeline_optv
...
read_design -verilog95   -golden -lastmod -noelab outputs_Dec01-23:19:04/RISC_V_pipeline_intermediate.v
...
#add_name_alias fv/RISC_V_pipeline/RISC_V_pipeline_intermediatev.singlebit.original_name.alias.json.gz -golden
...
set lec_version_required "19.10100"
if {$lec_version >= $lec_version_required} {
analyze_results -logfiles logs_Dec01-23:19:04/intermediate2final.lec.log
}
