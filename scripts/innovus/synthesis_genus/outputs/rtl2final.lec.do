...
# Generated on: Fri Dec 02 00:01:18 UTC 2022 (Fri Dec 02 00:01:18 UTC 2022)
...
set_log_file logs_Dec01-23:19:04/rtl2final.lec.log -replace

usage -auto -elapse

# Comparing intermediate 'fv_map' netlist vs. revised netlist.

set_verification_information fv_map_RISC_V_pipeline_optv_db

read_implementation_information fv/RISC_V_pipeline -golden fv_map -revised RISC_V_pipeline_optv
...
read_design -verilog95   -revised -lastmod -noelab outputs_Dec01-23:19:04/RISC_V_pipeline_opt.v
...
#add_name_alias fv/RISC_V_pipeline/RISC_V_pipeline_optv.singlebit.original_name.alias.json.gz -revised
...
set lec_version_required "19.10100"
if {$lec_version >= $lec_version_required} {
analyze_results -logfiles logs_Dec01-23:19:04/rtl2final.lec.log
}
