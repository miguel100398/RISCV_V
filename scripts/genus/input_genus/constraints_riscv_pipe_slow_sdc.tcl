# ITESO University
# Miguel Bucio
# User Constraint File: constraints_riscv_pipe_slow.tcl
...
# Clock definition
create_clock -name $EXTCLK  -add -period $EXTCLK_PERIOD [get_ports clk_pad]
...
## SDC FORMAT
set_input_delay -clock [get_clocks $EXTCLK] -add_delay 200 -name I_DELAY  [get_ports {reset_pad gpio_port_in_pad uart_rx_pad}]
...
## SDC FORMAT
set_output_delay -clock [get_clocks $EXTCLK] -add_delay 200 -name O_DELAY [get_ports {gpio_port_out_pad uart_tx_pad}]
...
set_load 5 -pin_load [get_ports {gpio_port_out_pad uart_tx_pad}]
