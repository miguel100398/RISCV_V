...
# Generated on: Mon Dec 05 06:47:27 UTC 2022 (Mon Dec 05 06:47:27 UTC 2022)
...
set_log_file logs_Dec05-06:14:40/rtl2intermediate.lec.log -replace

usage -auto -elapse

# Comparing intermediate 'fv_map' netlist vs. revised netlist.

set_verification_information fv_map_RISC_V_pipeline_intermediatev_db

read_implementation_information fv/RISC_V_pipeline -golden fv_map -revised RISC_V_pipeline_intermediatev
...
read_design -verilog95   -golden -lastmod -noelab fv/RISC_V_pipeline/fv_map.v.gz
elaborate_design -golden -root {RISC_V_pipeline}

read_design -verilog95   -revised -lastmod -noelab outputs_Dec05-06:14:40/RISC_V_pipeline_intermediate.v
elaborate_design -revised -root {RISC_V_pipeline}

#add_name_alias fv/RISC_V_pipeline/fv_map.singlebit.original_name.alias.json.gz -golden
...
#add_name_alias fv/RISC_V_pipeline/RISC_V_pipeline_intermediatev.singlebit.original_name.alias.json.gz -revised
...
set lec_version_required "19.10100"
if {$lec_version >= $lec_version_required} {
analyze_results -logfiles logs_Dec05-06:14:40/rtl2intermediate.lec.log
}
