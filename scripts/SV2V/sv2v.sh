...
FILES="$FILES ${SRC_AREA}/mul_array_test_latency.sv"
FILES="$FILES ${SRC_AREA}/mul_vec_array_test_latency.sv"
FILES="$FILES ${SRC_AREA}/mul_vedic_test_latency.sv"
FILES="$FILES ${SRC_AREA}/mul_vec_vedic_test_latency.sv"
