export DESIGN_NICKNAME = riscv_v_permutation_ALU
export DESIGN_NAME = riscv_v_permutation_ALU
export PLATFORM    = nangate45

export DIE_AREA    = 0.0 0.0 4000 4000
export CORE_AREA   = 200 200 4000 4000
...
export MIN_CLK_ROUTING_LAYER ?= metal3
