export DESIGN_NICKNAME = riscv_v_arithmetic_ALU
export DESIGN_NAME = riscv_v_arithmetic_ALU
export PLATFORM    = gf180

export DIE_AREA    = 0.0 0.0 6750 6750
export CORE_AREA   = 200 200 6750 6750
